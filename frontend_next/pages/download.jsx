                        ...
                        <div className="md:flex items-center justify-around gap-[30px] py-[40px] md:py-[120px]">
                            <div className="text-center md:w-1/2 md:text-left">
                                <div className="flex justify-center gap-[5px] items-center text-[24px] mb-[16px] font-[600] md:block md:text-[50px]">
                                    ...
                                    <h2>Download the <span className="text-[#1BD47B]">Yieldvest</span> Desktop App</h2>
                                </div>
                                ...
                                <p className="text-[16px] text-[#545964] font-[400] ">-Never loose charts</p>
                                <p className="text-[16px] text-[#545964] font-[400] ">-Zero popup ads</p>
                                <p className="text-[16px] text-[#545964] font-[400] mb-[20px]">-Faster navigation</p>
                                <div className="hidden md:flex justify-start items-center gap-[8px]">
                                    <a
                                        ...
                                        <img src={download2.src} /> Windows download
                                    </a>
                                    <a
                                        href="#"
                                        className="p-[8px] gap-[10px] flex rounded bg-black text-white items-center">
                                        <img src={download.src} /> Mac Pc download
                                    </a>
                                </div>
                            </div>
                            <div className="md:w-1/2">
                                <div className="flex items-center justify-center md:justify-end relative  p-4 h-auto">
                                    <img src={lead.src} className="mb-[16px] w-[334px] md:w-[90%] relative z-10"  />
                                    <img src={bg.src} alt="" className='absolute md:block right-0 w-[70%] bottom-0 z-1 top-0 hidden'/>
                                </div>
                                <div className="flex flex-col text-[8px] md:hidden justify-center items-center gap-[8px]">
                                    <a
                                        ...
                                        <img src={download.src}  /> Windows download
                                    </a>
                                    <br />
                                    <a
                                        href="#"
