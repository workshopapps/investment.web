  ...
  return (
    <>
      <div
        ...
        className='flex bg-[url("/src/assets/images/hero.svg")] relative bg-no-repeat bg-cover  items-center pl-5 md:pl-[50px] lg:pl-[100px] h-[160px] md:h-[360px]'
      >
        <div className="flex flex-col text-white gap-[6px] absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]">
          ...
          <p className="text-xs md:text-2xl font-[500] text-center">
      ...
      >
        <div className=" p-4 md:p-9  md:pt-14 md:pb-16 md:max-w-[390px] m-4 md:m-0 relative rounded-lg">
          <p className=" text-6xl font-bold text-[#455A64] text-center top-3 z-0">
            1
          </p>
          <img
            src={img1.src}
            alt=""
            className="w-full z-20 rounded-[6px] mb-10"
          />
          <h3 className="font-bold  mb-2 text-center  text-[#455A64] text-xl">
            Sign up for your free account
          </h3>
          <p className="text-[#66717E] text-center ">
            Sign up for your free account Open a premium account for full
        ...
        <div className=" p-4 md:p-9  md:pt-14 md:pb-16 md:max-w-[390px] m-4 md:m-0 relative rounded-lg">
          ...
          <img src={img2.src} alt="" className="w-full rounded-[6px] mb-10" />
        ...
        <div className=" p-4 md:p-9  md:pt-14 md:pb-16 md:max-w-[390px] m-4 md:m-0 relative rounded-lg">
          ...
          <img src={img3.src} alt="" className="w-full rounded-[6px] mb-10" />
          <h3 className="font-bold text-xl mb-2 text-center ">
      ...
      <button className="flex m-auto p-4 mb-6 bg-[#1BD47B] rounded-md items-center text-xl">
