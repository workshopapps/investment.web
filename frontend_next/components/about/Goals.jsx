...
//           At Yieldvest we use proprietary tech mixed with finacne give you
//           listings of top 10 stocks so you know the best for you at first
//           glance. A company makes it to our list after it passes through our
//           analysis and we`ve ensured it is the best choice for you.
//         </p>
//       </div>

//       <div className="md:bg-white  md:pt-14 md:pb-16 md:max-w-[390px] bg-[#F4F5F6] rounded-lg mx-[4em] md:mx-0">
//         <img src={img1.src} alt="" className="w-full rounded-t-lg" />
//         <h3 className="text-2xl font-semibold my-4 text-center md:text-left">
//           Mission
//         </h3>
...
//         <img src={img2.src} alt="" className="w-full rounded-t-lg" />
//         <h3 className="text-2xl font-semibold my-4 text-center md:text-left">
//           Vision
//         </h3>
//         <p className="text-[#66717E] text-xs md:text-sm text-center pb-10 md:pb-0 md:text-left">
//           To be the go-to platform for prospective investors to know what stocks
//           to buy. We do this by providing them with well-curated information
