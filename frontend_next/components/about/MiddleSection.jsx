    ...
    <div id="services" data-testid="middle-section">
      <div className="bg-[#fafaff] flex flex-col md:flex-row gap-6 md:gap-20 pt-10 md:pt-20 justify-center pb-10 md:pb-20 font-Hauora">
        <div className="bg-white p-5 md:p-10 md:pt-14 md:pb-16 md:max-w-[390px] mx-6 md:mx-0">
          ...
          <p className="text-[#66717E] text-center md:text-left">
            The word “yield” represents growth and expansion. It portrays profit
            and positive earnings for you, our customer. As our name implies, we
            hope to help you multiply your income greatly and help you become
        ...
        <div className="bg-white p-5 md:p-10 md:pt-14 md:pb-16 md:max-w-[390px] mx-6 md:mx-0">
          ...
          <p className="text-[#66717E] text-center md:text-left">
            Yieldvest is a stock advisory platform offering guidance to
            prospective investors, new or seasoned alike with our free and
            premium services it is simple, straightforward, and interface is
            very user-intuitive, with up-to-date valuations on growth potential,
            and market value of top companies or stocks to invest in.
          </p>
        </div>
        <div className="bg-white p-5 md:p-10 md:pt-14 md:pb-16 md:max-w-[390px] mx-6 md:mx-0">
          <h3 className="font-bold text-xl mb-2 text-center md:text-left">
          ...
          <p className="text-[#66717E] text-center md:text-left">
            Yieldvest guides individuals and businesses who need help knowing
            what stocks to invest in to make better and well-informed decisions
            on what stocks to purchase. We bring the best to you after analyzing
            each of these companies based on various metrics. Here`s how we help
      ...
      <div className="bg-[#fafaff] p-5 flex flex-col md:pl-[50px] md:pr-[50px] lg:pl-[100px] lg:pr-[100px] bg-left-bottom py-0 md:py-10">
        ...
        <div className="flex flex-row-reverse gap-8 md:gap-auto md:flex-col justify-center mt-8">
          ...
          <img
            className="hidden md:block mx-[25em]"
            src={img1.src}
            alt="h line"
          />
          <img className="block md:hidden" src={img0.src} alt="v line" />
        </div>
        ...
        <div className="bg-[#fafaff] flex flex-col md:flex-row gap-0 md:gap-20 pt-9 m-auto md:m-[5em] justify-center font-HauoraLight">
          <div className="relative flex flex-col md:flex-row gap-10 md:w-[60%]">
            <img className="hidden md:block" src={img2.src} alt="core " />
            <img className="md:hidden block" src={img4.src} alt="core " />
            <div className="flex flex-col pb-10 md:py-20 gap-5">
              ...
              <p className="text-sm md:text-lg">
                Having values as a team is essential to the team working as a
                single unit. We`re a group of diverse individuals, and working
                together can be tough but we learn to treat each other with
                respect and welcome every idea. Here are some of our core values
                that we think other companies should mirror;
              </p>
            </div>
          </div>
