...
const StockNew = ({ img, source, title, time }) => {
    return (
        <div
            className="w-full flex gap-[10px] justify-start items-start w-full border-1 border-[#E0E2E5] p-[10px]"
            style={{ borderBottom: '1px solid #E0E2E5' }}
        >
            <div
                className="h-[87px] md:h-[233px] rounded max-w-6xl min-w-[72px] md:max-w-[288px] md:min-w-[288px] "
                style={{
