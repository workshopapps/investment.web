...
const Goals = () => {
    return (
        <div className="flex flex-col md:flex-row bg-white p-5 md:pl-[50px] md:pr-[50px] lg:pl-[100px] gap-5 lg:gap-10 xl:gap-[90px] lg:pr-[100px]">
            <div className="">
                ...
                <p>
                    ...
                    to our list after it passes through our analysis and we have ensured it is the
                    best choice for you.
                </p>
            </div>
