...
const Goals = () => {
    return (
        <div
            data-testid="goals"
            className="flex flex-col md:flex-row w-full gap-5 lg:gap-10 xl:gap-[90px bg-white p-5 md:pl-[50px] md:pr-[50px] lg:pl-[100px] ] lg:pr-[100px]">
            <div className="">
                ...
                <p>
                    At MystockPlug we use proprietary tech mixed with finance to give you listings
                    of top 10 stocks so you know the best for you at first glance. A company makes
                    it to our list after it passes through our analysis and we have ensured it is
