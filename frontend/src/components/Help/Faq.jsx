        ...
        <div className="w-full font-Hauora text-xs sm:text-sm lg:text-base text-[#0A0B0D]">
            <div
                ...
                <div className="pr-3 h-full flex items-center">
                    <img
                        className={`w-[5.32px] sm:w-[6px] sm:h-auto md:w-[6.8px] h-[11.88px] lg:w-[7.1px] lg:h-[15.84px] transition-transform ${isFaqToggle ? '-rotate-90' : ''
                            }`}
                        src={dropdown}
                        alt="dropdown button"
                    />
            ...
            <div
                className={`px-2 py-3 md:px-3 lg:px-4 lg:py-4 w-full h-fit  bg-[#F4F5F6]  ${isFaqToggle ? 'block' : 'hidden'
                    }`}>
